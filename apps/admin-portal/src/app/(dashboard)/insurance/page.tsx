  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Student Insurance</h1>
          <p className="text-sm text-muted-foreground mt-1">Group accident insurance policy, claims management</p>
        </div>
      ...
      <div className="bg-card border border-border rounded-xl overflow-hidden">
        <div className="px-5 py-4 border-b border-border flex items-center justify-between">
          <h2 className="font-semibold text-foreground">Claims ({claims.length})</h2>
        </div>
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-100">
            {claims.map(claim => (
              <tr key={claim.ref} className="hover:bg-muted">
                <td className="px-5 py-3 font-mono text-xs text-muted-foreground">{claim.ref}</td>
                <td className="px-5 py-3">
                  <div className="font-medium text-foreground">{claim.studentName}</div>
