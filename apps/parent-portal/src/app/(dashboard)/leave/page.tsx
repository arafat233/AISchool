  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-foreground">Leave & Gate Pass</h1>
      ...
      {showForm && (
        <div className="bg-card rounded-xl border border-border p-5">
          <h2 className="text-sm font-semibold text-foreground mb-4">New Leave Application</h2>
      ...
      <div className="bg-card rounded-xl border border-border overflow-hidden">
        <div className="px-5 py-4 border-b border-border/50">
          <h2 className="text-sm font-semibold text-foreground">Leave Applications</h2>
        </div>
        <div className="divide-y divide-gray-100">
          ...
          {!data?.length && <p className="px-5 py-8 text-sm text-muted-foreground text-center">No applications yet</p>}
        </div>
      </div>
    </div>
  );
